...
public class BoardController {
	...
	// field
	private SelectBoardListCommand selectBoardLsitCommand;
	...
	@Autowired
	public void setCommand(SelectBoardListCommand selectBoardCommand,
		...
		this.selectBoardLsitCommand = selectBoardCommand;
	...
	public String selectBoardList(Model model) {
		selectBoardLsitCommand.execute(model);
