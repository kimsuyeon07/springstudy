...
<head>
	...
	<link rel="stylesheet" href="resources/asset/css/join.css">
...
<body>
	...
	<div id="join" class="container con">
	
		<header>
			<h1  class="en_B_lt">JOIN</h1>
		</header>
		
		<section>
			<form id="f" method="post">
				
				<label for="id" class="B">아이디</label>
				<div class="id_box">
				...
				<label for="pw" class="B">비밀번호</label>
				<input type="password" name="pw" id="pw" placeholder="PassWord">
				<span id="pw_message" class="message"></span>
				
				<label for="pw2" class="B">비밀번호 확인</label>
		...
		<footer>
			<div class="back_page">
				<a href="index.do" class="L">로그인화면으로 돌아가기</a>
			</div>
		</footer>
